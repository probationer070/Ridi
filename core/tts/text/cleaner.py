...
#     from core.tts.text import chinese
#     from core.tts.text.symbols import symbols
# else:
#     from core.tts.text import chinese2 as chinese
#     from core.tts.text.symbols2 import symbols
...
def clean_text(text, language, version=None):
    ...
    language_module = __import__("core.tts.text."+language_module_map[language],fromlist=[language_module_map[language]])
